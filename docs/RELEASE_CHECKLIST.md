...
- Build the Windows installer ZIP with `scripts\windows\package-installer.ps1`.
...
- Verify the Windows installer ZIP extracts to an MSI, MSI checksum, and install note.
